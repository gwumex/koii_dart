...
> Note: This release has breaking changes.
 ...
 - **BREAKING** **FEAT**: Add KoiiClient (#144).
...
> Note: This release has breaking changes.
 ...
 - **BREAKING** **FEAT**: Add `commitment` parameters to koii client.

## 0.6.0

> Note: This release has breaking changes.

 - **FEAT**: Add a function to validate koii addresses (#22).
...
> Note: This release has breaking changes.
 ...
 - **BREAKING** **CHORE**: Rename library to koii.

## 0.2.0

 - Bump "koii_dart" to `0.2.0`.
