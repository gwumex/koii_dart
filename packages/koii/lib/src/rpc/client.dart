...
import 'package:koii/src/rpc/dto/dto.dart';
import 'package:koii/src/rpc/helpers.dart';
import 'package:koii/src/rpc/json_rpc_client.dart';
...
abstract class RpcClient {
  ...
  ///
  /// [see this document]: https://docs.koii.com/developing/clients/jsonrpc-api#configuring-state-commitment
  ///
  /// [encoding]
  ///
  ...
  ///
  /// If one or more --known-validator arguments are provided to koii-validator,
  ...
  ///
  /// [searchTransactionHistory] If true, a koii node will search its ledger cache for any signatures not
  ...
  /// Returns the current koii versions running on the node
  Future<KoiiVersion> getVersion();
