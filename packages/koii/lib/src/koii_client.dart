...
import 'package:koii/src/encoder/encoder.dart';
...
class KoiiClient {
  ...
  ///
  /// If [timeout] is null then timeout from [KoiiClient] is used.
  ...
  /// Creates a koii transfer message to send [lamports] SOL tokens from [source]
  /// to [destination].
  ///
